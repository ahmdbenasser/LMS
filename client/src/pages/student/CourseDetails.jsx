...
const CourseDetails = () => {
  ...
  const [isEducator, setIsEducator] = useState(false); // ✅ تعريف state جديد
  const { allCourses, calcRating, currency } = useContext(AppContext);
  ...
  // Function calc number of Lectures in the course
    ...
    <>
      ...
      >
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          {/* Review and ratings */}
          <div className="flex items-center space-x-2 pb-1 text-sm">
            ...
            <div className="flex">
              {[...Array(5)].map((_, i) => (
                <img
                  ...
                  key={i}
                  src={
                    i < Math.floor(calcRating(courseData))
                      ? assets.star
                      : assets.star_blank
                  }
                  alt=""
          ...
          <p className="">
            Course by{" "}
            <span className="text-blue-600 underline">Techn-School</span>
          </p>
            ...
            <div className="mt-5">
              {courseData.courseContent.map((chapter, index) => (
                ...
                >
                  ...
                  >
                    <ul className="px-4 list-disc py-2 text-gray-600 border-t border-gray-300">
        ...
        {/* Right Column */}
        <div
          className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white
          ...
          <div className="p-5">
            ...
            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
              ...
              <div className="flex items-center gap-1">
                ...
                <p>{calcCourseDuration(courseData)} lessons</p>
              </div>
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                <li>Lifetime access with free updated.</li>
                <li>Step-by-step, hands-on project guidance. </li>
                <li>Dowanloadable resources and source code.</li>
                <li>Quizzes o test your knowledga.</li>
